...
Route::group(['namespace' => 'Saascart\Phpunit\Co', 'middleware' => 'web'], function () {
...
Route::group(['namespace' => 'Saascart\Phpunit\Co',  'middleware' => ['pBl', 'web']], function () {
...
Route::group(['namespace' => 'Saascart\Phpunit\Co', 'middleware' => ['pMd', 'pRd', 'pWBl']], function () {
